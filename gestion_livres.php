                    ...
                    <form action="ajout.php" method="POST">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="number" class="form-control" id="annee" name="annee" placeholder="2024" required>
                            </div>
                            <div class="col-md-2 mb-3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                <a href="modifier.php?id=<?= $row['id_livre'] ?>" class="btn btn-warning btn-sm me-1">
                                                    <i class="bi bi-pencil-fill"></i>
                                                </a>
                                                <a href="delete.php?id=<?= $row['id_livre'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce livre ?');">
